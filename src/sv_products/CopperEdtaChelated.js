        ...
        <div className="product-page">
            <div className="product-hero">
                <div className="hero-content">
                    <h1>Copper EDTA Chelated</h1>
                    <p className="product-subtitle">High-Quality Chelated Copper for Plant Nutrition</p>
                ...
                <div className="hero-image">
                    <img src="/src/sv_assets/SPCP.jpg" alt="Copper EDTA Chelated" />
                </div>
            </div>
            <div className="product-container">
                <div className="product-main">
                    <section className="product-section">
                        ...
                        <p>
                            Copper EDTA Chelated is a high-quality chelated copper fertilizer used for correcting copper deficiencies in plants. This product provides copper in a form that is easily absorbed by plants, ensuring optimal growth and development.
                        </p>
                    </section>
                    <section className="product-section">
                        ...
                        <div className="specs-grid">
                            ...
                            <div className="spec-item"><span className="spec-label">Color</span><span className="spec-value">Blue</span></div>
                            <div className="spec-item"><span className="spec-label">CAS No</span><span className="spec-value">14025-15-1</span></div>
                            <div className="spec-item"><span className="spec-label">Chemical Name</span><span className="spec-value">Acid Copper Disodium Complex</span></div>
                            <div className="spec-item"><span className="spec-label">pH</span><span className="spec-value">6.5 - 7.5 (1 wt % solution)</span></div>
                            <div className="spec-item"><span className="spec-label">Copper Content</span><span className="spec-value">14.0% (+/- 0.5) as Cu</span></div>
                            ...
                            <div className="spec-item"><span className="spec-label">Molecular Formula</span><span className="spec-value">C10H12N2O8CuNa2</span></div>
                            <div className="spec-item"><span className="spec-label">Molecular Weight</span><span className="spec-value">397.7</span></div>
                    ...
                    <section className="product-section">
                        ...
                        <div className="applications-grid">
                            <div className="application-card">
                                <h3>Agriculture</h3>
                                <p>Used to correct copper deficiencies in crops and improve plant health.</p>
                            </div>
                            <div className="application-card">
                                <h3>Hydroponics</h3>
                                <p>Ideal for hydroponic systems where copper is needed in soluble form.</p>
                            </div>
                            <div className="application-card">
                                <h3>Foliar Application</h3>
                                <p>Applied directly to plant leaves for quick copper absorption.</p>
                            </div>
                        </div>
                    </section>
                    <section className="product-section">
...
export default CopperEdtaChelated; 