        ...
        <div className="product-page">
            ...
            <div className="product-hero">
                <div className="hero-content">
                    <h1>Folic Acid</h1>
                    <p className="product-subtitle">Vitamin B9 for Pharmaceutical and Food Fortification Applications</p>
                    <div className="price-info">
                        <span className="price">₹ 2200/Kg</span>
                        <span className="moq">Minimum Order Quantity: 10 Kg</span>
                    </div>
                </div>
                <div className="hero-image">
                    <img src="/src/assets/chemical_placeholder.jpg" alt="Folic Acid" />
                </div>
            </div>
            ...
            <div className="product-container">
                <div className="product-main">
                    ...
                    <section className="product-section">
                        ...
                        <p>
                            Folic Acid (Vitamin B9) is a water-soluble vitamin essential for cell division and DNA synthesis. 
                            It is widely used in pharmaceutical manufacturing, food fortification, and nutritional supplements 
                            for its vital role in human health and development.
                        </p>
                    ...
                    <section className="product-section">
                        ...
                        <div className="specs-grid">
                            ...
                            <div className="spec-item">
                                ...
                                <span className="spec-value">Yellow Crystalline Powder</span>
                            </div>
                            <div className="spec-item">
                            ...
                            <div className="spec-item">
                                ...
                                <span className="spec-value">C19H19N7O6</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="product-section">
                        ...
                        <div className="applications-grid">
                            <div className="application-card">
                                ...
                                <p>Used in vitamin supplements, prenatal vitamins, and pharmaceutical formulations for health benefits.</p>
                            </div>
                            <div className="application-card">
                            ...
                            <div className="application-card">
                                ...
                                <p>Used in dietary supplements and multivitamin formulations for daily nutrition.</p>
                            </div>
                            <div className="application-card">
                                <h3>Animal Feed</h3>
                            ...
                            <div className="application-card">
                                ...
                                <p>Used in clinical settings for treating folate deficiency and related conditions.</p>
                            </div>
                            <div className="application-card">
