...
const FulvicAcidPowder = () => {
    return (
        <div className="product-page">
            <div className="product-hero">
                <div className="product-hero-content">
                    <div className="product-hero-text">
                        <h1>Fulvic Acid Powder</h1>
                        <p className="product-subtitle">
                            Natural organic compound for agricultural and industrial applications
                        </p>
                        <div className="product-highlights">
                            <div className="highlight-item">
                                <FontAwesomeIcon icon={faCheckCircle} />
                                <span>Natural organic compound</span>
                            </div>
                            <div className="highlight-item">
                                <FontAwesomeIcon icon={faCheckCircle} />
                    ...
                    <div className="product-hero-image">
                        <img src="/src/assets/clear.jpg" alt="Fulvic Acid Powder" />
                    </div>
                </div>
            </div>
            ...
            <div className="product-content">
                <div className="product-main">
                    <section className="product-section">
                        ...
                        <p>
                            Fulvic Acid Powder is a natural organic compound derived from humic substances. 
                            It is rich in essential minerals and trace elements, making it an excellent 
                            supplement for agricultural applications. This powder form offers easy handling 
                            and application while maintaining the beneficial properties of fulvic acid.
                        </p>
                    </section>
                    ...
                    <section className="product-section">
                        ...
                        <div className="specs-grid">
                            <div className="spec-item">
                                <h4>Appearance</h4>
                                <p>Brown to dark brown powder</p>
                            </div>
                            <div className="spec-item">
                                <h4>Solubility</h4>
                    ...
                    <section className="product-section">
                        ...
                        <div className="applications-grid">
                            <div className="application-item">
                                ...
                                <h4>Agriculture</h4>
                                <p>Soil amendment and plant growth enhancement in farming</p>
                            </div>
                            <div className="application-item">
                    ...
                    <section className="product-section">
                        ...
                        <div className="benefits-list">
                            ...
                            <div className="benefit-item">
                                <FontAwesomeIcon icon={faCheckCircle} />
                                <div>
                                    <h4>Plant Growth Stimulation</h4>
                                    <p>Promotes root development and overall plant vigor</p>
                                </div>
                            </div>
                            <div className="benefit-item">
                                <FontAwesomeIcon icon={faCheckCircle} />
                    ...
                    <section className="product-section">
                        ...
                        <div className="product-gallery">
                            <div className="gallery-item">
                                <img src="/src/assets/clear.jpg" alt="Fulvic Acid Powder View 1" />
                                <p>Fulvic Acid Powder</p>
                            </div>
                            <div className="gallery-item">
                                <img src="/src/assets/clear.jpg" alt="Fulvic Acid Powder View 2" />
                                <p>Agricultural Application</p>
                            </div>
                            <div className="gallery-item">
                                <img src="/src/assets/clear.jpg" alt="Fulvic Acid Powder View 3" />
                                <p>Soil Amendment</p>
                            </div>
                            <div className="gallery-item">
                                <img src="/src/assets/clear.jpg" alt="Fulvic Acid Powder View 4" />
...
export default FulvicAcidPowder; 